...
class AccountFetcher extends _Model.ModelFetcher {
  constructor(...args) {
    ...
    return _temp = super(...args), this.collectionName = 'Accounts', this.modelName = 'Account', _temp;
  }
...
class AccountMutator extends _Model.ModelMutator {
  constructor(...args) {
    ...
    return _temp2 = super(...args), this.collectionName = 'Accounts', this.modelName = 'Account', _temp2;
  }
...
class Account extends _Model.Model {
  constructor(...args) {
    ...
    return _temp3 = super(...args), this.collectionName = 'Accounts', this.modelName = 'Account', _temp3;
  }
  // ---------------------------------------------------------------------------
  ...
  static createYodlee(yodleeAccount, accountLinkID, userID, isTestAccount = false) {
    const raw = _extends({}, (0, _dbUtils.createModelStub)('Account'), {
...
Account.Fetcher = new AccountFetcher();
Account.Mutator = new AccountMutator();
