...
exports.genSetUserInfo = exports.genFetchUserInfo = undefined;
...
let genSetUserInfo = exports.genSetUserInfo = (() => {
  var _ref2 = _asyncToGenerator(function* (userInfo) {
    return getUserInfoCollection().doc(userInfo.id).set(userInfo);
  });

  return function genSetUserInfo(_x2) {
