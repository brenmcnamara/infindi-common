...
function isPending(refreshInfo) {
  return refreshInfo.raw.refreshStatus === 'IN_PROGRESS' || refreshInfo.raw.refreshStatus === 'REFRESH_TRIGGERED';
}

function isComplete(refreshInfo) {
  return refreshInfo.raw.refreshStatus === 'SUCCESS' || refreshInfo.raw.refreshStatus === 'PARTIAL_SUCCESS';
}
